...
async def create_booking(
    ...
    cache_key = f"free_slots:{start.date()}:{booking.service_id}"  # (я добавил)
    await redis.delete(cache_key)  # (я добавил)
...
async def cancel_booking(
    ...
    cache_key = f"free_slots:{booking.start_time.date()}:{booking.service_id}"  # (я добавил)
    await redis.delete(cache_key)  # (я добавил)
